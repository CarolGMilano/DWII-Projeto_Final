...
export class TelaVisualizarDetalhes implements OnInit {
  ...
  solicitacao1: SolicitacaoDetalhe = {
    ...
    historico: [
      ...
      { dataHora: new Date('2025-09-09'), estado: EstadoSolicitacaoT.ORCADA, funcionario: this.funcionarioLogado, observacao: 'Solicitação orçada' }
    ],
    orcamento: { 
      servico: [
  ...
  solicitacao2: SolicitacaoDetalhe = {
    ...
    historico: [
      { dataHora: new Date('2025-09-01'), estado: EstadoSolicitacaoT.ABERTA, observacao: 'Solicitação recebida' },
      { dataHora: new Date('2025-09-03'), estado: EstadoSolicitacaoT.ORCADA, funcionario: this.funcionarioLogado, observacao: 'Solicitação orçada' },
  ...
  solicitacao3: SolicitacaoDetalhe = {
    ...
    historico: [
      { dataHora: new Date('2025-09-01'), estado: EstadoSolicitacaoT.ABERTA, observacao: 'Solicitação recebida' },
      { dataHora: new Date('2025-09-04'), estado: EstadoSolicitacaoT.ORCADA, funcionario: this.funcionarioLogado, observacao: 'Orçamento enviado' },
  ...
  solicitacao4: SolicitacaoDetalhe = {
    ...
    historico: [
      { dataHora: new Date('2025-09-01'), estado: EstadoSolicitacaoT.ABERTA, observacao: 'Solicitação recebida' },
      { dataHora: new Date('2025-09-05'), estado: EstadoSolicitacaoT.ORCADA, funcionario: this.funcionarioLogado, observacao: 'Orçamento enviado' },
  ...
  solicitacao5: SolicitacaoDetalhe = {
    ...
    historico: [
      ...
      { dataHora: new Date('2025-09-12'), estado: EstadoSolicitacaoT.ARRUMADA, funcionario: this.funcionarioLogado, observacao: 'Manutenção realizada' },
      { dataHora: new Date('2025-09-13'), estado: EstadoSolicitacaoT.PAGA, observacao: 'Manutenção paga' }
    ],
    orcamento: { 
      servico: [
        { descricao: 'Troca de tela', preco: 250 },
        { descricao: 'Reparo teclado', preco: 150 }
      ],
      valorTotal: 400,
      aprovada: true
    },
